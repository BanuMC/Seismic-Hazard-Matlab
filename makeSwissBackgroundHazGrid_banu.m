function [scgx,scgy,scP,logP] = makeSwissBackgroundHazGrid_banu(mBackGroundRates,nIntLevel,Mmin,Mmax,dm,r)
% function[scgx,scgy,scP,logP] = makeSwissBackgroundHazGrid(sFileIn,sFileOut,nIntLevel)
% -------------------------------------------------------------------------
